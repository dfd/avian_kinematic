...
use bevy::{ecs::query::Has, input::mouse::AccumulatedMouseMotion, math::*, prelude::*};
...
impl Plugin for CameraControllerPlugin {
    fn build(&self, app: &mut App) {
        app.add_event::<CameraAction>()
            .add_systems(Update, (mouse_input,).chain());
    }
}
...
fn mouse_input(accumulated_mouse_motion: Res<AccumulatedMouseMotion>) {
    ...
    if delta != Vec2::ZERO {
        ...
        let camera_sensitivity = CameraSensitivity::default();
